    ...
    <div className="min-h-screen bg-[#0b0b0b] text-white flex flex-col">
      ...
      {!hideLayout && (
        <a
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#20bd5a] rounded-full flex items-center justify-center shadow-lg shadow-[#25D366]/30 transition-transform hover:scale-110"
