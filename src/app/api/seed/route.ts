...
async function seedDatabase() {
  ...
  const productsData = [
    ...
    { categoryId: catPrep.id, name: 'Work Table', slug: 'work-table', description: 'Stainless steel work table for commercial kitchen prep areas, SS304 construction with undershelf. Provides a durable and hygienic surface for food preparation, built to withstand the demands of busy professional kitchens.', shortDescription: 'Stainless steel work table with undershelf', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catPrep.id, name: 'Work Table with Sink', slug: 'work-table-with-sink', description: 'Combined work table with integrated sink bowl for efficient food preparation. Features a deep sink bowl alongside a spacious prep surface, allowing washing and prep in one convenient station.', shortDescription: 'Work table with integrated sink bowl', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catPrep.id, name: 'Veggie Washer', slug: 'veggie-washer', description: 'Commercial vegetable washing machine with spray system for bulk cleaning. Designed to thoroughly clean large quantities of vegetables quickly, saving time and ensuring food safety in commercial kitchens.', shortDescription: 'Commercial vegetable washing machine', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catPrep.id, name: 'Mixer Grinder', slug: 'mixer-grinder', description: 'Heavy-duty commercial mixer grinder for spices and batter preparation. Powerful motor with stainless steel jars, ideal for grinding spices, making chutneys, and preparing batter in commercial quantities.', shortDescription: 'Heavy-duty commercial mixer grinder', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    ...
    { categoryId: catCooking.id, name: 'Stock Pot Burner', slug: 'stock-pot-burner', description: 'Heavy-duty stock pot burner for large volume boiling and simmering. Powerful flame output supports large stock pots, ideal for preparing stocks, soups, and boiling in commercial kitchens and catering operations.', shortDescription: 'Heavy-duty stock pot burner', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Single Burner Range', slug: 'single-burner-range', description: 'Single burner commercial gas range for targeted cooking. Compact design perfect for small kitchens, food stalls, and as an additional cooking station for specialized tasks.', shortDescription: 'Single burner commercial gas range', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Two Burner Range', slug: 'two-burner-range', description: 'Two burner commercial gas range for medium-duty cooking. Ideal for small restaurants, cafes, and food service operations that require multiple cooking zones in a compact footprint.', shortDescription: 'Two burner commercial gas range', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Three Burner Range', slug: 'three-burner-range', description: 'Three burner commercial gas range for versatile cooking. Provides three independent cooking zones with individual flame control, suitable for medium-sized restaurants and kitchen lines.', shortDescription: 'Three burner commercial gas range', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Four Burner Range', slug: 'four-burner-range', description: 'Four burner commercial gas range for high-volume kitchens. Offers four powerful burners with robust construction, designed for continuous use in busy restaurants, hotels, and catering operations.', shortDescription: 'Four burner commercial gas range', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Conti Burner Range with Griddle', slug: 'conti-burner-range-with-griddle', description: 'Continental style burner range with integrated griddle plate. Combines open burners with a flat griddle surface, allowing simultaneous cooking of different dishes — perfect for diverse menus.', shortDescription: 'Continental burner range with griddle', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Three Burner Chinese Range', slug: 'three-burner-chinese-range', description: 'Three burner Chinese cooking range with wok cradle. Designed specifically for high-heat wok cooking with reinforced wok cradles and powerful burners, essential for Chinese and Asian restaurants.', shortDescription: 'Three burner Chinese cooking range', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Chapati Plate with Puffer', slug: 'chapati-plate-with-puffer', description: 'Gas chapati plate with puffer for bulk chapati preparation. Features a flat cooking surface and integrated puffer for puffing chapatis, enabling high-volume production for restaurants and canteens.', shortDescription: 'Gas chapati plate with puffer', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Dosa Plate', slug: 'dosa-plate', description: 'Commercial dosa plate with griddle surface for perfect dosas. Precision-engineered flat surface ensures even heat distribution for crispy, golden dosas every time in high-volume South Indian kitchens.', shortDescription: 'Commercial dosa plate', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'SS Tandoor Charcoal', slug: 'ss-tandoor-charcoal', description: 'Stainless steel charcoal tandoor for authentic flavor. Traditional charcoal-fired tandoor oven in a modern stainless steel body, delivering authentic smoky flavor for naan, kebabs, and tandoori dishes.', shortDescription: 'Stainless steel charcoal tandoor', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'SS Tandoor Gas', slug: 'ss-tandoor-gas', description: 'Stainless steel gas tandoor for convenient tandoori cooking. Gas-powered tandoor offers consistent temperature control without the hassle of charcoal, perfect for restaurants wanting authentic tandoori results.', shortDescription: 'Stainless steel gas tandoor', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Shawarma Machine Gas', slug: 'shawarma-machine-gas', description: 'Gas shawarma machine with vertical spit for even roasting. Rotating vertical spit with gas burners ensures even cooking and browning, ideal for restaurants and street food vendors serving shawarma.', shortDescription: 'Gas shawarma machine', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Shawarma Machine Electric', slug: 'shawarma-machine-electric', description: 'Electric shawarma machine with temperature control. Features adjustable heating elements and precise temperature control for consistent results, suitable for indoor kitchens without gas supply.', shortDescription: 'Electric shawarma machine', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Rotesserie Grill', slug: 'rotesserie-grill', description: 'Commercial rotisserie grill for chicken and meat roasting. Slow-rotating spit ensures even browning and juicy results, perfect for restaurants, delis, and takeaway outlets serving roasted chicken.', shortDescription: 'Commercial rotisserie grill', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Bar-B-Que', slug: 'bar-b-que', description: 'Commercial BBQ grill for outdoor and indoor grilling. Heavy-duty construction with adjustable grates and heat zones, designed for restaurants, catering events, and outdoor cooking stations.', shortDescription: 'Commercial BBQ grill', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Idli Steamer', slug: 'idli-steamer', description: 'Commercial idli steamer for bulk idli preparation. Multi-tier steaming system cooks large batches of idlis evenly and efficiently, essential for South Indian restaurants and canteens.', shortDescription: 'Commercial idli steamer', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Deep Fat Fryer', slug: 'deep-fat-fryer', description: 'Gas deep fat fryer for crispy fried foods. Powerful gas heating ensures fast temperature recovery, ideal for frying samosas, pakoras, french fries, and other fried items in commercial kitchens.', shortDescription: 'Gas deep fat fryer', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Electric Deep Fat Fryer', slug: 'electric-deep-fat-fryer', description: 'Electric deep fat fryer with temperature control. Precise thermostat control maintains consistent oil temperature for perfect frying results, suitable for restaurants, food courts, and snack bars.', shortDescription: 'Electric deep fat fryer', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Salamander', slug: 'salamander', description: 'Salamander grill for browning, melting and finishing dishes. Overhead infrared heating element provides intense top heat for gratinating, browning, and finishing, essential in modern restaurant kitchens.', shortDescription: 'Salamander grill', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Pressure Fryer', slug: 'pressure-fryer', description: 'Pressure fryer for fast and juicy fried chicken. Combines pressure cooking with deep frying for moisture-sealed, juicy results in less time — the secret behind perfect fried chicken.', shortDescription: 'Commercial pressure fryer', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Sandwich Griller', slug: 'sandwich-griller', description: 'Commercial sandwich griller with ribbed plates. Ribbed cast iron plates create attractive grill marks while melting cheese and heating fillings, perfect for cafes, sandwich shops, and quick-service restaurants.', shortDescription: 'Commercial sandwich griller', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catCooking.id, name: 'Conveyor Pizza Oven', slug: 'conveyor-pizza-oven', description: 'Conveyor pizza oven for consistent pizza baking. Continuous conveyor system ensures even baking with adjustable speed and temperature, ideal for high-volume pizza production in pizzerias and food chains.', shortDescription: 'Conveyor pizza oven', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    ...
    { categoryId: catCooking.id, name: 'Pizza Oven Electric/Gas', slug: 'pizza-oven-electric-gas', description: 'Pizza oven available in electric and gas variants. Versatile pizza oven with deck-style baking for authentic pizza results, available in both electric and gas configurations to suit any kitchen setup.', shortDescription: 'Pizza oven electric/gas', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },

    // Serving Equipment (9 products) — indices 36-44
    { categoryId: catServing.id, name: 'Hot Bain Marie', slug: 'hot-bain-marie', description: 'Heated bain marie for keeping food warm during service. Multiple containers with precise temperature control keep prepared dishes at safe serving temperatures, essential for buffet lines and banquet service.', shortDescription: 'Heated bain marie', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catServing.id, name: 'Pick Up Table', slug: 'pick-up-table', description: 'Stainless steel pick up table for food service area. Provides an organized serving station where kitchen staff can place ready dishes for pickup, streamlining the flow between kitchen and dining area.', shortDescription: 'Stainless steel pick up table', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
    { categoryId: catServing.id, name: 'SS Trolley', slug: 'ss-trolley', description: 'Stainless steel utility trolley for kitchen transport. Versatile trolley for transporting ingredients, equipment, and prepared food throughout the kitchen, built with durable SS construction for daily commercial use.', shortDescription: 'Stainless steel utility trolley', price: 0, stock: 50, leadTime: '5-7 days', featured: false, status: 'active' },
